...
def show_travel_stats():
    ...
    # number of times you switched on light
    info += f"\n You switched on light {total_travel['light']} time{'s' if is_plural(total_travel['light']) else ''}\n"
...
def handle_front_lightning():
    ...
    while is_car_moving:
        ...
        if light_intensity < MIN_LIGHT_INTENSITY:
            ...
            total_travel["n_of_light"] = total_travel["n_of_light"] + 1
            turn_off_light()
        else:
